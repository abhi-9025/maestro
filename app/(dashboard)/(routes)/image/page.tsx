...
const ImagePage = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      // clear the form after completion of request
  ...
  return (
    <div>
      <Heading
        ...
        description="Generate Image via prompt"
        icon={ImageIcon}
                ...
                <FormItem className="col-span-12 lg:col-span-6">
                  <FormControl className=" m-0 p-0">
                    <Input
                      ...
                      disabled={isLoading}
                      placeholder="A picture of blah blah "
                      {...field}
                    />
                  </FormControl>
                </FormItem>
      ...
      <div className="space-y-4 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mt-8 ">
         {images.map((image)=>(
          <Card key={image} className=" rounded-lg overflow-hidden ml-8">
